...
<form id="contactForm" method="POST" action="{{ Request::getRequestUri() }}">
    ...
    <input type="text" id="lname" name="lname" placeholder="Last Name" value="{{ request()->get("lname") }}" required>

    <textarea id="body" name="body" style="width: 75vw; height: 40vh; min-width: 300px;" placeholder="Type Your Message Here" required></textarea>
